        ...
        <div className="flex items-center justify-between mb-4">
          ...
          {type === 'officers' && allOfficersData && allOfficersData.length > 0 && (
            <button
              ...
              className="group px-4 py-2 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white text-sm font-bold rounded-lg shadow-md shadow-green-500/30 hover:shadow-lg hover:shadow-green-500/40 hover:-translate-y-0.5 transition-all duration-200 flex items-center space-x-2"
            >
