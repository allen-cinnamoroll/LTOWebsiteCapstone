      ...
      {currentViolations.length > 0 ? (
        <div className="space-y-3 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
          {currentViolations.map((violation, index) => {
            ...
            return (
              <div key={violation._id || index} className="flex items-center space-x-4 p-3 border-2 border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors bg-white dark:bg-gray-900">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex space-x-3">
              <button
                ...
                className="px-4 py-2 text-sm font-semibold text-white bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed rounded-lg shadow-md transition-all duration-200 flex items-center space-x-1"
              >
              ...
              <div className="flex items-center space-x-2">
                <span className="px-4 py-2 text-sm font-semibold text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 border-2 border-gray-300 dark:border-gray-600 rounded-lg">
