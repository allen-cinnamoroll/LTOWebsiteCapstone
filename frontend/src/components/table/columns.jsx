...
// Bin columns for accidents - with restore and delete actions (no edit)
export const accidentBinColumns = (onRestore, onPermanentDelete, submitting) => [
  {
    accessorKey: "blotterNo",
    header: "Blotter No.",
    cell: ({ row }) => <div className="font-medium text-gray-900 dark:text-gray-200 text-xs">{row.getValue("blotterNo")}</div>,
...
// Bin columns for drivers - with restore and delete actions (no edit)
export const driverBinColumns = (onRestore, onPermanentDelete, submitting) => [
  {
    accessorKey: "ownerRepresentativeName",
    header: ({ column }) => (
      <DataTableColumnHeader column={column} title={"Owner"} disableHide={true} />
...
export const vehicleColumns = (onEdit, onRenew, onDelete, submitting) => [
  {
    accessorKey: "plateNo",
    header: "Plate No.",
...
// Bin columns for vehicles - with restore and delete actions (no edit)
export const vehicleBinColumns = (onRestore, onPermanentDelete, submitting) => [
  {
    accessorKey: "plateNo",
    header: "Plate No.",
    cell: ({ row }) => <div className="font-medium text-gray-900 dark:text-gray-200 text-xs">{row.getValue("plateNo")}</div>,
