    ...
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-2xl h-[80vh] bg-gradient-to-br from-slate-50 to-blue-50 dark:from-gray-900 dark:to-gray-800 border-0 shadow-2xl w-full p-0 overflow-hidden flex flex-col">
            ...
            <div className="flex mb-4 sticky top-0 z-10 bg-white/90 dark:bg-transparent backdrop-blur-sm pb-2 -mx-6 px-6 -mt-6 pt-6 border-b border-gray-200 dark:border-[#424242]">
              <div className="flex-1 flex space-x-1 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-1 rounded-lg shadow-lg border border-gray-200 dark:border-[#424242]">
                ...
                >
                  ...
                  <span className="hidden sm:inline">Assigned Vehicles</span>
                </Button>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 flex-1">
              ...
              <div className="space-y-2">
                ...
                <div className="bg-white dark:bg-gray-800 p-2 rounded-lg border border-gray-200 dark:border-[#424242] shadow-sm hover:shadow-md transition-all duration-200 hover:border-blue-300 dark:hover:border-blue-600">
                  ...
                  <p className="text-xs font-semibold text-gray-900 dark:text-gray-100 ml-4">{driverData.ownerRepresentativeName || "N/A"}</p>
                    </div>
                ...
                <div className="bg-white dark:bg-gray-800 p-2 rounded-lg border border-gray-200 dark:border-[#424242] shadow-sm hover:shadow-md transition-all duration-200 hover:border-blue-300 dark:hover:border-blue-600">
                  ...
                  <p className="text-xs font-semibold text-gray-900 dark:text-gray-100 ml-4">{driverData.birthDate ? formatSimpleDate(driverData.birthDate) : "None"}</p>
                  </div>
                ...
                <div className="bg-white dark:bg-gray-800 p-2 rounded-lg border border-gray-200 dark:border-[#424242] shadow-sm hover:shadow-md transition-all duration-200 hover:border-blue-300 dark:hover:border-blue-600">
                  ...
                  <p className="text-xs font-semibold text-gray-900 dark:text-gray-100 ml-4">{driverData.contactNumber || "None"}</p>
                    </div>
                ...
                <div className="bg-white dark:bg-gray-800 p-2 rounded-lg border border-gray-200 dark:border-[#424242] shadow-sm hover:shadow-md transition-all duration-200 hover:border-blue-300 dark:hover:border-blue-600">
                  ...
                  <div className="ml-4 flex items-center gap-2 text-xs">
                    ...
                    <span className="text-gray-500 dark:text-gray-400">{formatDisplayDate(driverData?.createdAt)}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="bg-white dark:bg-gray-800 p-2 rounded-lg border border-gray-200 dark:border-[#424242] shadow-sm hover:shadow-md transition-all duration-200 hover:border-blue-300 dark:hover:border-blue-600">
                  ...
                  <div className="ml-4 flex items-center gap-2">
                    ...
                    {driverData.hasDriversLicense && driverData.driversLicenseNumber && (
                      <span className="text-xs font-semibold text-gray-900 dark:text-gray-100">{driverData.driversLicenseNumber}</span>
                    )}
                  </div>
                </div>
                <div className="bg-white dark:bg-gray-800 p-2 rounded-lg border border-gray-200 dark:border-[#424242] shadow-sm hover:shadow-md transition-all duration-200 hover:border-blue-300 dark:hover:border-blue-600">
                  ...
                  <p className="text-xs font-semibold text-gray-900 dark:text-gray-100 ml-4">{displayOrNotIndicated(driverData.address?.purok)}</p>
                    </div>
                <div className="bg-white dark:bg-gray-800 p-2 rounded-lg border border-gray-200 dark:border-[#424242] shadow-sm hover:shadow-md transition-all duration-200 hover:border-blue-300 dark:hover:border-blue-600">
                  <label className="text-[10px] font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide flex items-center gap-1">
                    <MapPin className="h-3 w-3" />
                  ...
                  <p className="text-xs font-semibold text-gray-900 dark:text-gray-100 ml-4">{displayOrNotIndicated(driverData.address?.barangay)}</p>
                  </div>
                <div className="bg-white dark:bg-gray-800 p-2 rounded-lg border border-gray-200 dark:border-[#424242] shadow-sm hover:shadow-md transition-all duration-200 hover:border-blue-300 dark:hover:border-blue-600">
                  <label className="text-[10px] font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide flex items-center gap-1">
                    <MapPin className="h-3 w-3" />
                  ...
                  <p className="text-xs font-semibold text-gray-900 dark:text-gray-100 ml-4">{displayOrNotIndicated(driverData.address?.municipality)}</p>
                    </div>
                <div className="bg-white dark:bg-gray-800 p-2 rounded-lg border border-gray-200 dark:border-[#424242] shadow-sm hover:shadow-md transition-all duration-200 hover:border-blue-300 dark:hover:border-blue-600">
                  <label className="text-[10px] font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide flex items-center gap-1">
                    <MapPin className="h-3 w-3" />
                  ...
                  <p className="text-xs font-semibold text-gray-900 dark:text-gray-100 ml-4">{displayOrNotIndicated(driverData.address?.province)}</p>
                  </div>
                ...
                <div className="bg-white dark:bg-gray-800 p-2 rounded-lg border border-gray-200 dark:border-[#424242] shadow-sm hover:shadow-md transition-all duration-200 hover:border-blue-300 dark:hover:border-blue-600">
                  ...
                  <div className="ml-4 flex items-center gap-2 text-xs">
                    ...
                    <span className="text-gray-500 dark:text-gray-400">•</span>
                    <span className="text-gray-500 dark:text-gray-400">{driverData?.updatedAt && driverData?.updatedBy ? formatDisplayDate(driverData.updatedAt) : 'Not yet updated'}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {activeTab === "vehicles" && (
              <div className="flex-1 flex flex-col min-h-0">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="text-sm font-semibold text-gray-800 dark:text-gray-200">Assigned Vehicles</h3>
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                    {driverData.vehicleIds && driverData.vehicleIds.length > 0 ? (
                      driverData.vehicleIds.map((vehicle, index) => (
                        <div key={index} className="bg-white dark:bg-gray-800 p-2 rounded-lg border border-gray-200 dark:border-[#424242] hover:border-blue-300 dark:hover:border-blue-600 shadow-sm">
                          <div className="text-[10px] text-gray-500 dark:text-gray-400 uppercase tracking-wide flex items-center gap-1">
                            <FileText className="h-3 w-3" /> File Number
                          </div>
                          <button
                            onClick={() => handleFileNumberClick(vehicle.fileNo)}
                            className="text-sm font-semibold text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 hover:underline break-all mt-0.5"
                            title={`View vehicle details for ${vehicle.fileNo}`}
                          >
                            {vehicle.fileNo}
                          </button>
                          {vehicle.plateNo && (
                            <div className="text-xs text-gray-500 dark:text-gray-400">Plate: {vehicle.plateNo}</div>
                          )}
                        </div>
                      ))
                    ) : (
                      <div className="text-xs text-gray-500 dark:text-gray-400">No vehicles assigned.</div>
                    )}
                  </div>
                </div>
              </div>
          ...
          {/* Sticky Footer */}
          <div className="flex-shrink-0 border-t bg-white dark:bg-transparent border-gray-200 dark:border-[#424242] px-6 py-3">
